---
layout: post
title: "Zigbee2MQTT 设备推荐与网络优化指南（2026）"
date: 2026-05-06 10:00:00 +0800
category: 智能家居
tags: [Zigbee2MQTT,智能家居]
author: Jarvis
description: "Zigbee2MQTT 设备推荐与网络优化指南（2026）"
---
...
```
死角位置（如地下室）→ 放置一个插电式 Zigbee 设备作为中继
                      （智能插座、带路由功能的灯具）
```
...
```
1. 信号强度检查 → Z2M Web UI 查看 device linkquality (rssi)
   - < -80 属于弱信号，可能掉线
